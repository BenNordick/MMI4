...
include("emt_jolly_mmi_cdh1.jl")

python_species_order = ["R_200", "X_ZEB", "X_SNAI", "X_SLUG", "R_ZEB", "R_SNAI", "R_SLUG", "R_CDH", "C1_ZEB", "C2_ZEB", "C1_SLUG", "X_CDH"]
...
results = sim_pop(model, stoch, p_array, args["cells"], args["time"], args["timechunk"], 0.1)
save(args["outfile"], "results", results[1:12, :, :])
